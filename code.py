...
if __name__ == '__main__':
    ...
    try:
        ...
        # fn = 'image6.jpeg'
        # fn = 'output_blurred_image_2.jpg'
        fn = 'image_3.jpg'

    win = 'deconvolution'
    
    img = cv2.imread(fn, 0)  # 0 to read the image in grayscale
    if img is None:
    ...
    def update(_):
        ...
        # Store the result in the global variable for saving later
        global result_image
        result_image = res
    ...
    while True:
        ...
        if ch == ord('s'):
            ...
            if result_image is not None:
                cv2.imwrite('deconvolved_image_3.jpg', (result_image * 255).astype(np.uint8))
                print('Image saved as deconvolved_result.jpg')
